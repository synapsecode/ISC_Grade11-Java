...
public class MyDateExtensions {
	...
	public static String getDateSuffix(int n){
        String d = n + "";
	...
	public static int JulianSumUpto(int n){
	...
	public static String convertDate(String dx){
        String ret = "";
        int d, m, y;
	...
	public static int getJulianDate(int d, int m, int y){
	...
	public static int getDateDifference(String dx, String dy){
	...
	public static String[] getMonthFromJulianDate(int d){
	...
	public static String julianToGregorianDate(int d, int y){
        String ret = "";
        if(isLeapYear(y)){
            daysInMonth[1] = 29;
        }
    ...
    public static String futurejulianToGregorianDate(int n, int dn, int y){
        String ret = "";
